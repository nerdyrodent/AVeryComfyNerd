...
<img src="Reposer_Plus_bypass.png" width="256px"></img>|Reposer Plus Bypass Edition. As above, but with a full bypass option for segment anything<br>Updated due to custom node output changes :\ | SD 1.5
